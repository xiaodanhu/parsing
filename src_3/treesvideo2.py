...
def load_trees_alt(mode, path='/data/xiaodan8/research/dataset/FineGym'):
    ...
    print("--------------> Action Label", id2actionlabel)
    # exit()
...
####            print(trees[0].label)
        ...
        #     # trees.append(InternalTreebankNode(id2activitylabel[act], childrenan))
        #
        # else:
        #     trees.append(InternalTreebankNode('UNK', childrenact))
        #     # trees.append(InternalTreebankNode('UNK', childrenan))
