...
class CubeDataset(torch.utils.data.Dataset):
                    ...
                    if len(activity_label_list) > 0:
                        if activity_id != activity_label_list[-1]:
                            ...
                            if ct_actv < self.max_activity_len_per_record - 1:
                                ...
                                masks.append(mask)
                                #if vname=='0LtLS9wROrk' and mode=='test':
                                #    print(activity_id,activity_id, action_label, phrase_label,activity_key)
    ...
    def get_data(self, record: Record):
        ...
        return snippet_fts, labels, record.masks, og_locations
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default="/data/xiaodan8/research/dataset/FineGym", help="")
