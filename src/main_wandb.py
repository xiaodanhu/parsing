    ...
    with wandb.init():
        ...
        for epoch in itertools.count(start=1):
            ...
            for start_index in range(0, len(train_parse), args.batch_size):
                ...
                wandb.log({"epoch": epoch, "batch": start_index // args.batch_size + 1, "loss": batch_loss_value / args.batch_size})
...
def main(config=None):
    ...
    subparser.add_argument("--batch-size", type=int, default=16, help='250 by default')
    ...
    subparser.add_argument("--exp-name", type=str, default="Oct31")
...
if __name__ == "__main__":
    ...
    parameters_dict.update({
        ...
        'num_layers': {'values': [2, 4, 8, 16, 32, 64]},
        'd_model': {
            'distribution': 'q_log_uniform_values',
            'q': 8,
            'min': 512,
